"""
verification/task_router.py — High-Speed Task-Aware Model Routing.

Speed Optimization:
- Final Verdict prefers Groq (1.8s) first, with Gemini as strong fallback.
- Contradiction detection distributes across groq-1..4 for instant parallel processing.
"""
...
# ★ HIGH-SPEED TASK MAPPING:
# Fast Groq keys prioritized for speed, Gemini as robust reasoning fallback
TASK_SPECIFIC_PREFERENCES: Dict[str, List[str]] = {
    "classification": [
        "groq-1", "groq-2", "groq-3", "groq-4", "gemini", "openrouter", "hf-72b"
    ],
    "search_planning": [
        "groq-2", "groq-3", "groq-4", "groq-1", "gemini", "openrouter", "hf-72b"
    ],
    "decomposition": [
        "groq-3", "groq-4", "groq-1", "groq-2", "gemini", "openrouter", "hf-72b"
    ],
    "evidence_extraction": [
        "groq-4", "groq-3", "groq-2", "groq-1", "gemini", "openrouter", "hf-72b"
    ],
    "contradiction_detection": [
        "groq-1", "groq-2", "groq-3", "groq-4", "gemini", "openrouter", "hf-72b"
    ],
    # ★ FIX: Groq-1/2 generates verdict in 1.8s (vs 9s on Gemini)
    "final_verdict": [
        "groq-1", "groq-2", "groq-3", "groq-4", "gemini", "openrouter", "hf-72b"
    ],
}
...
TIER_PREFERENCES: Dict[str, List[str]] = {
    "fast": [
        "groq-1", "groq-2", "groq-3", "groq-4", "openrouter", "gemini", "hf-32b", "hf-72b",
    ],
    "balanced": [
        "groq-4", "groq-3", "groq-2", "groq-1", "gemini", "openrouter", "hf-72b", "hf-32b",
    ],
    "reasoning": [
        "groq-1", "groq-2", "groq-3", "groq-4", "gemini", "openrouter", "hf-72b", "hf-32b",
    ],
    "strong": [
        "groq-1", "groq-2", "groq-3", "groq-4", "gemini", "openrouter", "hf-72b", "hf-32b",
    ],
...
class TaskRouter:
    ...
    def select_providers(
        ...
        preferences = TASK_SPECIFIC_PREFERENCES.get(
            task_type, TIER_PREFERENCES.get(tier, TIER_PREFERENCES["balanced"])
        )
        ...
        logger.info(
            "[TASK ROUTER] task=%-24s tier=%-8s provider=%-12s",
